...
compose.desktop {
    application {
        ...
        // Recovery is a small emergency utility — ProGuard adds complexity without benefit.
        // Disable it to avoid the Java 21 class-version conflict with ProGuard 7.2.2.
